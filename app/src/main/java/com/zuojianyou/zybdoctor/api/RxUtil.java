...
public class RxUtil {
     ...
     * @return
     */
    public static <T> FlowableTransformer<HttpResponse<T>, T> handleMyResults() {   //compose判断结果
            ...
            public Flowable<T> apply(Flowable<HttpResponse<T>> httpResponseFlowable) {
                return httpResponseFlowable.flatMap(new Function<HttpResponse<T>, Flowable<T>>() {
                    ...
                    public Flowable<T> apply(HttpResponse<T> tMyHttpResponse) {
                        if ("0".equals(tMyHttpResponse.getCode())) {
                            return createData(tMyHttpResponse.getData());
                        } else {
                            return Flowable.error(new ApiException(tMyHttpResponse.getErrMsg(), tMyHttpResponse.getCode()));
                        }
                    }
