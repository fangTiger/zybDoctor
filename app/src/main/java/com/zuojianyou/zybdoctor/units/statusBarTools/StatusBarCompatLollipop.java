...
public class StatusBarCompatLollipop {
    ...
    public static void setStatusBarColor(Activity activity, int statusColor) {
        setStatusBarColor(activity.getWindow(),statusColor);
    }
    ...
    public static void setStatusBarColor(Window window, int statusColor) {
        ...
        window.getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_VISIBLE);//状态栏占位是否显示
    ...
    public static void translucentStatusBar(Activity activity, boolean hideStatusBarBackground) {
        translucentStatusBar(activity.getWindow(), hideStatusBarBackground);
    }
