package com.zuojianyou.zybdoctor.base.data;
...
public class SpData {
    ...
    private static SharedPreferences get() {
        if (sp == null)
            sp = BaseApplication.getAppContext().getSharedPreferences("SpData", Context.MODE_PRIVATE);
        return sp;
    }
    ...
    public static void setDoctorInfo(String info) {
        SharedPreferences.Editor editor = get().edit();
        editor.putString("sp_doctor_info", info);
        editor.commit();
    }

    public static void clearDoctorInfo() {
        SharedPreferences.Editor editor = get().edit();
        editor.remove("sp_doctor_info");
        editor.commit();
    }

    public static String getDoctorInfo() {
        String nickname = get().getString("sp_doctor_info", "");
        return nickname;
    }
