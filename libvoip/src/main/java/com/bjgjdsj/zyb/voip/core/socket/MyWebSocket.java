package com.bjgjdsj.zyb.voip.core.socket;
...
import com.bjgjdsj.zyb.voip.core.util.StringUtil;
...
public class MyWebSocket extends WebSocketClient {
    ...
    private void handlePeers(Map map) {
        ...
        if (data != null) {
            ...
            if (data.get("roomSize") != null) {
                mRoomSize = (int) data.get("roomSize");
            }
            this.iEvent.onPeers(you, connections,mRoomSize);
        }
    }
